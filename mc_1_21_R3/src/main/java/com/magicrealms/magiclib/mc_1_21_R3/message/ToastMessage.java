...
public class ToastMessage extends AbstractMessage {
    ...
    private ToastMessage() {
        this.MINECRAFT_KEY = ResourceLocation.fromNamespaceAndPath("magiclib", "toast");
    ...
    private void sendToast(Player player, ItemStack icon, String msg, AdvancementType type) {
        ...
        List<Packet<? super ClientGamePacketListener>> packets = List.of(new ClientboundUpdateAdvancementsPacket(
                false,
