...
import com.magicrealms.magiclib.common.command.filter.command.CaseInsensitiveRegexCommandFilter;
import com.magicrealms.magiclib.common.command.filter.command.RegexCommandFilter;
