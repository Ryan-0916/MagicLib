...
import com.magicrealms.magiclib.bukkit.dispatcher.IMessageDispatcher;
...
public class MessageDispatcher implements IMessageDispatcher {
    ...
    public void sendMessage(MagicRealmsPlugin plugin,
        ...
        if (receiver instanceof Player player) {
            ...
            String msg = StringUtil.replacePlaceholders(message, map);
            AtomicBoolean sent = new AtomicBoolean(false);
            Arrays.stream(MessageType.values()).forEach(type -> StringUtil.getStringBetweenTags(msg, type.getTag()).ifPresent(m -> {
                sent.set(true);
